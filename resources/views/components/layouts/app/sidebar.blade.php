        ...
        <x-sidebar sticky stashable class="border-r border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900">
            ...
            <x-navlist>
                ...
                <x-navlist.group :heading="__('Management')">
                    <x-navlist.item before="phosphor-briefcase" :href="route('dashboard')" :current="request()->routeIs('dashboard')">
                        {{ __('Projects') }}
                    </x-navlist.item>
                    <x-navlist.item before="phosphor-users" :href="route('coming-soon')" :current="false">
                        {{ __('Resources') }}
                    </x-navlist.item>
                    <x-navlist.item before="phosphor-chart-line-up" :href="route('coming-soon')" :current="false">
                        {{ __('Reports') }}
                    </x-navlist.item>
                </x-navlist.group>

                <x-navlist.group :heading="__('Business Development')">
                    <x-navlist.item before="phosphor-handshake" :href="route('coming-soon')" :current="false">
                        {{ __('Opportunities') }}
                    </x-navlist.item>
                    <x-navlist.item before="phosphor-target" :href="route('coming-soon')" :current="false">
                        {{ __('Pipeline') }}
                    </x-navlist.item>
                    <x-navlist.item before="phosphor-calendar-check" :href="route('coming-soon')" :current="false">
                        {{ __('Meetings') }}
                    </x-navlist.item>
                </x-navlist.group>

                <x-navlist.group :heading="__('Analytics')">
                    <x-navlist.item before="phosphor-chart-bar" :href="route('coming-soon')" :current="false">
                        {{ __('Utilization') }}
                    </x-navlist.item>
                    <x-navlist.item before="phosphor-trend-up" :href="route('coming-soon')" :current="false">
                        {{ __('Trends') }}
                    </x-navlist.item>
                    <x-navlist.item before="phosphor-file-text" :href="route('coming-soon')" :current="false">
                        {{ __('Decision Log') }}
                    </x-navlist.item>
                </x-navlist.group>
            </x-navlist>
